...
const { getPurchasePdfReport,getPurchaseCsvReport,getSalesCsvReport, getSalesPdfReport, getBalanceSheetPdfReport,getBalanceSheetCsvReport } = require('../controllers/reportController');
